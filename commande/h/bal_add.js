...
module.exports = {
    ...
    .setName('bal_add')
    .setDescription("permet a un admin de donner de l'argent a un joueur")
    .addUserOption( Option => 
        Option.setName('user')
            .setDescription("l'utilisateur a qui vous voulez ajouter de l'argent")
            .setRequired(true)
    )
    .addStringOption( Option => 
        Option.setName('ammount')
            .setDescription("le montant que vous voulez donner a l'utilisateur")
            .setRequired(true)
    )
